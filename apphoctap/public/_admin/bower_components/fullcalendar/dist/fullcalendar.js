...
var ListView = /** @class */ (function (_super) {
    ...
    function ListView(calendar, viewSpec) {
        var _this = _super.call(this, calendar, viewSpec) || this;
        _this.segSelector = '.fc-list-detail'; // which elements accept event actions
        _this.scroller = new Scroller_1.default({
            overflowX: 'hidden',
            overflowY: 'auto'
        });
...
var Iterator = /** @class */ (function () {
    ...
    /* Calls a method on every detail passing the arguments through */
...
var ListEventRenderer = /** @class */ (function (_super) {
    ...
    ListEventRenderer.prototype.fgSegHtml = function (seg) {
        ...
        var classes = ['fc-list-detail'].concat(this.getClasses(eventDef));
        ...
        return '<tr class="' + classes.join(' ') + '">' +
            (this.displayEventTime ?
                '<td class="fc-list-detail-time ' + theme.getClass('widgetContent') + '">' +
                    (timeHtml || '') +
                    '</td>' :
                '') +
            '<td class="fc-list-detail-marker ' + theme.getClass('widgetContent') + '">' +
            ...
            '></span>' +
            '</td>' +
            '<td class="fc-list-detail-title ' + theme.getClass('widgetContent') + '">' +
